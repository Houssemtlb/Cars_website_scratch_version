...
class TopBarView extends View {
    ...
    {
        echo"<div class='bar'>";
            echo"<a href='http://localhost/cars_website_scratch_version/public/'><img src='http://localhost/cars_website_scratch_version/public/assets/images/logo.svg' alt='logo' style='height: 90%'/></a>";
        ...
        echo"<a href='https://www.instagram.com'><img src='http://localhost/cars_website_scratch_version/public/assets/images/instagram.svg' alt='logo' style='height: 90%; filter: invert(100%) sepia(30%) saturate(0%) hue-rotate(176deg) brightness(118%) contrast(101%);'/></a>";
