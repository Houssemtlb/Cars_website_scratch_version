...
class VehiculeModel extends Model{
    ...
    {
        $this->connect();
        $request = $this->connection->prepare("UPDATE vehicule SET  marque_id = :marque_id, model = :model, version = :version, annee = :annee, prix = :prix, moteur = :moteur, cylindree = :cylindree, consommation = :consommation, nb_cylindres = :nb_cylindres, nb_places = :nb_places, type = :type, longueur = :longueur, largeur = :largeur, hauteur = :hauteur, note = :note  WHERE (vehicule_id = :vehicule_id)");
    ...
    public function getLastVehiculeInserted()
    {
